...
<<<<<<< HEAD
def run_command(cmds, rs, tenant_name, max_size, batch_size, s3_list, s3_client, bucketName, log_file):
    global max_val
=======
...
<<<<<<< HEAD
def execute(filename, hostname, rs, execution_plan, max_size, batch_size, s3_client, s3_bucket):
=======
...
<<<<<<< HEAD
        run_command(prev_command, rs, tenant_name, max_size, batch_size, s3_list, s3_client, s3_bucket, log_file)
...
>>>>>>> b808cdc363a39996f23633760435b53ecf025d69
            ...
            #start = time.time()
<<<<<<< HEAD
            run_command(command, rs, tenant_name, max_size, batch_size, s3_list, s3_client, s3_bucket, log_file)
=======
...
>>>>>>> b808cdc363a39996f23633760435b53ecf025d69
    ...
    for i in range(len(FileName)):
        if i == 0:
            ...
            servers = rs[7:10]
<<<<<<< HEAD
        p = Process(target=execute, args=(FileName[i], HostName, servers, execution[FileName[i]], max_size, batch_size, s3client[i], S3BucketName[i]))
=======
